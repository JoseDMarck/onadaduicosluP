...
if(!function_exists('discussion_styles')) {
    ...
    function discussion_styles() {
        ...
        if(discussion_load_woo_assets()) {
            $style_dynamic_deps_array[] = 'discussion_woo';
        }
...
if(!function_exists('discussion_scripts')) {
    ...
    function discussion_scripts() {
        ...
        if(discussion_options()->getOptionValue('google_maps_api_key') != "") {

            $google_maps_api_key = discussion_options()->getOptionValue('google_maps_api_key');
        ...
        wp_enqueue_script('discussion_modules', MIKADO_ASSETS_ROOT.'/js/modules.js', array('jquery'), false, true);
