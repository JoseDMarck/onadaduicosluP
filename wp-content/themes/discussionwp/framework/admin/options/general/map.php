...
if ( ! function_exists('discussion_general_options_map') ) {
    /**
     * General options page
     */
    function discussion_general_options_map() {
        ...
        do_action('discussion_before_general_options_map');

        $panel_design_style = discussion_add_admin_panel(
            array(
                'page'  => '',
        ...
        $additional_google_fonts_container = discussion_add_admin_container(
            array(
                'parent'            => $panel_design_style,
        ...
        $panel_settings = discussion_add_admin_panel(
            array(
                'page'  => '',
                'name'  => 'panel_settings',
                'title' => 'Behaviour'
        ...
        $panel_custom_code = discussion_add_admin_panel(
            array(
                'page'  => '',
        ...
        $panel_google_api = discussion_add_admin_panel(
            array(
                'page'  => '',
        ...
        discussion_add_admin_field(
            array(
                ...
                'description' => 'Insert your Google Maps API key here.',
                'parent'      => $panel_google_api
            )
        );
    }

    add_action( 'discussion_options_map', 'discussion_general_options_map', 1);
}