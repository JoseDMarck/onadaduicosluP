...
if ( ! function_exists('discussion_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function discussion_configure_visual_composer() {
	...
	add_action('vc_after_init', 'discussion_configure_visual_composer');
}

if ( ! function_exists('discussion_configure_visual_composer_grid_elemets') ) {
	...
	function discussion_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'discussion_configure_visual_composer_grid_elemets');
}

if ( ! function_exists('discussion_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function discussion_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'discussion_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Mkd_Image_With_Hover_Info extends WPBakeryShortCodesContainer {}
}

/*** Row ***/
if ( ! function_exists('discussion_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function discussion_vc_row_map() {

		$animations = array(
			'No animation' => '',
			'Elements Shows From Left Side' 	=>	'mkd-element-from-left',
			'Elements Shows From Right Side'	=> 	'mkd-element-from-right',
			'Elements Shows From Top Side'		=>	'mkd-element-from-top',
			'Elements Shows From Bottom Side'	=>	'mkd-element-from-bottom',
			'Elements Shows From Fade'			=>	'mkd-element-from-fade'
		);
	...
	add_action('vc_after_init', 'discussion_vc_row_map');
}

/*** Widget Sidebar ***/
if ( ! function_exists('discussion_vc_widget_sidebar_map') ) {
	/**
	 * Map VC Widget Sidebar shortcode
	 * Hooks on vc_after_init action
	 */
	function discussion_vc_widget_sidebar_map() {
	...
	add_action('vc_after_init', 'discussion_vc_widget_sidebar_map');
}