...
add_action( 'woocommerce_product_thumbnails', 'discussion_woocommerce_before_thumbnails', 15 );
add_action( 'woocommerce_product_thumbnails', 'discussion_woocommerce_after_thumbnails', 25 );