...
if(!function_exists('discussion_woocommerce_before_thumbnails')){
	function discussion_woocommerce_before_thumbnails(){
		print '<div class="thumbnails columns-4">';
	}
}

if(!function_exists('discussion_woocommerce_after_thumbnails')){
	function discussion_woocommerce_after_thumbnails(){
		print '</div>';
	}
}